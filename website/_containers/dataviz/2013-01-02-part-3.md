...
That’s it! Now we just have some boilerplate code for that `main()` function:
...
You should see `file_sf.geojson` file now! You can open it up in your text editor; a snippet should look like this:
